    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waiter', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant.waiter')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='waiter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='restaurant.waiter'),
        ),
        migrations.CreateModel(
            name='Waiter_Shift',
            fields=[
